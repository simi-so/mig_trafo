...
-- DROP TABLE public.simidata_postgres_db;
...
-- DROP TABLE public.simidata_raster_ds;
...
-- DROP TABLE public.simidata_table_ds;
...
-- DROP TABLE public.simiiam_identity;
...
-- DROP TABLE public.simiiam_role;
...
-- DROP TABLE public.simiproduct_data_product_pub_scope;
...
-- DROP TABLE public.simidata_external_table;
...
-- DROP TABLE public.simidata_model_schema;
...
-- DROP TABLE public.simidata_postgres_table;
...
-- DROP TABLE public.simidata_table_field;
...
-- DROP TABLE public.simiiam_group;
...
-- DROP TABLE public.simiiam_role_group_link;
...
-- DROP TABLE public.simiiam_user;
...
-- DROP TABLE public.simiproduct_data_product;
...
-- DROP TABLE public.simiproduct_product_list;
...
-- DROP TABLE public.simiproduct_single_actor;
...
-- DROP TABLE public.simiiam_group_user_link;
...
-- DROP TABLE public.simiiam_role_user_link;
...
-- DROP TABLE public.simiproduct_data_set_view;
...
-- DROP TABLE public.simiproduct_facade_layer;
...
-- DROP TABLE public.simiproduct_layer_group;
...
-- DROP TABLE public.simiproduct_map;
...
-- DROP TABLE public.simiproduct_properties_in_facade;
...
-- DROP TABLE public.simiproduct_properties_in_list;
...
-- DROP TABLE public.simidata_raster_view;
...
-- DROP TABLE public.simidata_table_view;
...
-- DROP TABLE public.simidata_view_field;
...
-- public.simiiam_permission definition

-- Drop table

-- DROP TABLE public.simiiam_permission;

CREATE TABLE public.simiiam_permission (
	id uuid NOT NULL,
	"version" int4 NOT NULL,
	create_ts timestamp NULL,
	created_by varchar(50) NULL,
	...
	data_set_view_id uuid NOT NULL,
	role_id uuid NOT NULL,
	CONSTRAINT simiiam_permission_pkey PRIMARY KEY (id),
	CONSTRAINT fk_simiiam_permission_on_data_set_view FOREIGN KEY (data_set_view_id) REFERENCES simiproduct_data_set_view(id),
	CONSTRAINT fk_simiiam_permission_on_role FOREIGN KEY (role_id) REFERENCES simiiam_role(id)
);
CREATE UNIQUE INDEX idx_simi_permission_unq_data_set_view_id_role_id ON public.simiiam_permission USING btree (data_set_view_id, role_id) WHERE (delete_ts IS NULL);
CREATE INDEX idx_simiiam_permission_on_data_set_view ON public.simiiam_permission USING btree (data_set_view_id);
CREATE INDEX idx_simiiam_permission_on_role ON public.simiiam_permission USING btree (role_id);
